...
- **[Hosting Platforms](hosting-platforms.md)** - Platform comparison and selection guide
...
- **[AWS Deployment Guide](aws/README.md)** - Complete AWS deployment with ECS, RDS, and CloudFront
- **[AWS Infrastructure](aws/infrastructure.md)** - Terraform configurations and AWS services
- **[AWS Monitoring](aws/monitoring.md)** - CloudWatch dashboards and AWS-specific monitoring

#### Azure Deployment

- **[Azure Deployment Guide](azure/README.md)** - Complete Azure deployment with AKS, Azure SQL, and CDN
- **[Azure Infrastructure](azure/infrastructure.md)** - Bicep/ARM templates and Azure services
- **[Azure Monitoring](azure/monitoring.md)** - Application Insights and Azure-specific monitoring
...
├── hosting-platforms.md         # Platform comparison and selection guide
...
│   └── monitoring.md           # AWS monitoring and observability
└── azure/                      # Azure-specific deployment guides
    ├── README.md               # Azure deployment overview
    ├── infrastructure.md       # Azure infrastructure setup
    └── monitoring.md           # Azure monitoring and observability
```
...
For comprehensive AWS deployment using ECS Fargate, RDS, and managed services:
...
For Azure deployment using AKS, Azure SQL, and Azure services:
...
For other hosting platforms and general deployment guidance:

- **[Hosting Platforms](hosting-platforms.md)** - Platform comparison and selection
- **[Production Deployment](production-deployment.md)** - General production deployment guide
